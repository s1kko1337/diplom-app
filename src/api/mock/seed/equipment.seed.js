  ...
  return [
    {
      ...
      operatingHours: 4820,
      lastMaintenance: { type: 'ТО-2', date: '2026-02-15', hours: 4500 },
      subsystemHealth: { hydraulic: 88, electrical: 95, mechanical: 82, compressor: 90 },
    ...
    },
    {
      ...
      lastMaintenance: { type: 'ТО-1', date: '2026-01-20', hours: 12100 },
      subsystemHealth: { hydraulic: 85, electrical: 92, mechanical: 78, compressor: 86 },
      sensors: createSensors({
    ...
    },
    {
      ...
      statusLabel: 'ПРОСТОЙ',
      operatingHours: 1200,
      lastMaintenance: { type: 'ТО-1', date: '2026-01-30', hours: 1100 },
      subsystemHealth: { hydraulic: 75, electrical: 88, mechanical: 80, compressor: 82 },
      sensors: createSensors({
    ...
    },
    {
      ...
      operatingHours: 8900,
      lastMaintenance: { type: 'ТО-2', date: '2026-02-01', hours: 8500 },
      subsystemHealth: { hydraulic: 52, electrical: 61, mechanical: 45, compressor: 58 },
      sensors: createSensors({
    ...
    },
    {
      ...
      statusLabel: 'В РАБОТЕ',
      operatingHours: 320,
      lastMaintenance: { type: 'ТО-1', date: '2026-02-12', hours: 250 },
      subsystemHealth: { hydraulic: 97, electrical: 99, mechanical: 96, compressor: 98 },
      sensors: createSensors({
    ...
    },
    {
      ...
      statusLabel: 'В РАБОТЕ',
      operatingHours: 6700,
      lastMaintenance: { type: 'ТО-1', date: '2026-01-18', hours: 6500 },
      subsystemHealth: { hydraulic: 84, electrical: 91, mechanical: 79, compressor: 87 },
      sensors: createSensors({
    ...
    },
    {
      ...
      lastMaintenance: { type: 'ТО-3', date: '2026-01-22', hours: 15000 },
      subsystemHealth: { hydraulic: 42, electrical: 68, mechanical: 55, compressor: 60 },
      sensors: createSensors({
    ...
    },
    {
      ...
      statusLabel: 'В РАБОТЕ',
      operatingHours: 2100,
      lastMaintenance: { type: 'ТО-2', date: '2026-02-11', hours: 2000 },
      subsystemHealth: { hydraulic: 91, electrical: 94, mechanical: 87, compressor: 93 },
      sensors: createSensors({
