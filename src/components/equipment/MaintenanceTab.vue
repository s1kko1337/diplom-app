<template>
  <Tabs v-model="activeSubTab" default-value="overview" class="space-y-4">
    <TabsList>
    ...
    <!-- ── Обзор: график + следующее ТО + план ─────────────────────────── -->
          ...
          <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
              ...
              <Button
                ...
                variant="outline"
                class="h-8 text-xs"
                :disabled="maintenanceStore.checklist.length === 0"
                @click="handlePrintChecklist"
              >
...
function handlePrintChecklist() {
  router.push({
    ...
    params: { id: props.equipmentId },
    query: { type: selectedChecklistType.value },
  })
}
